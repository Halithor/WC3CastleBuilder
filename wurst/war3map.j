...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'h00H', 628.4, - 372.7, 176.435)
    set u=CreateUnit(p, 'h00H', 15.0, - 579.4, 116.755)
endfunction
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'e004', 2086.0, 70.7, 170.050)
endfunction
