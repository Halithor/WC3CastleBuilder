...
//===========================================================================
// 
// Castle Builder 2019 v0.03
// 
//   Warcraft III map script
//   Generated by the Warcraft III World Editor
//   Date: Sat Apr 13 23:26:57 2019
//   Map Author: Halithor
// 
//===========================================================================
...
function CreateNeutralHostileBuildings takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'h00L', 0.0, 928.0, 270.000)
    set u=CreateUnit(p, 'h00F', 160.0, 928.0, 270.000)
    set u=CreateUnit(p, 'h00F', 288.0, 928.0, 270.000)
    set u=CreateUnit(p, 'h00F', 352.0, 928.0, 270.000)
    set u=CreateUnit(p, 'h00F', 224.0, 928.0, 270.000)
    set u=CreateUnit(p, 'h00F', - 160.0, 928.0, 270.000)
    set u=CreateUnit(p, 'h00F', - 224.0, 928.0, 270.000)
    set u=CreateUnit(p, 'h00F', - 288.0, 928.0, 270.000)
    set u=CreateUnit(p, 'h00F', - 352.0, 928.0, 270.000)
    set u=CreateUnit(p, 'h00F', 928.0, 352.0, 270.000)
    set u=CreateUnit(p, 'h00F', 928.0, 288.0, 270.000)
    set u=CreateUnit(p, 'h00F', 928.0, 224.0, 270.000)
    set u=CreateUnit(p, 'h00F', 928.0, 160.0, 270.000)
    set u=CreateUnit(p, 'h00F', 928.0, - 352.0, 270.000)
    set u=CreateUnit(p, 'h00F', 928.0, - 288.0, 270.000)
    set u=CreateUnit(p, 'h00F', 928.0, - 224.0, 270.000)
    set u=CreateUnit(p, 'h00F', 928.0, - 160.0, 270.000)
    ...
    set u=CreateUnit(p, 'h00F', - 928.0, 224.0, 270.000)
    set u=CreateUnit(p, 'h00F', - 928.0, 160.0, 270.000)
    set u=CreateUnit(p, 'h00M', 928.0, 0.0, 270.000)
    set u=CreateUnit(p, 'h00M', - 928.0, 0.0, 270.000)
endfunction
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'e004', 592.6, 789.9, 203.901)
    set u=CreateUnit(p, 'e004', 809.1, 546.0, 42.474)
    set u=CreateUnit(p, 'e004', 823.8, - 591.0, 330.688)
    set u=CreateUnit(p, 'e004', 527.6, - 826.9, 286.521)
    set u=CreateUnit(p, 'e004', - 576.3, - 837.4, 271.206)
    set u=CreateUnit(p, 'e004', - 821.4, - 522.2, 349.815)
    set u=CreateUnit(p, 'e004', - 582.0, 807.2, 240.465)
    set u=CreateUnit(p, 'e004', - 797.6, 572.6, 171.787)
endfunction
...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'nfoh', 0.0, 0.0, 270.000)
    set u=CreateUnit(p, 'nfoh', 5504.0, 10752.0, 270.000)
endfunction
